...
from .models import Subjects, Students, Courses, CustomUser, Attendance, AttendanceReport, LeaveReportStudent, FeedbackStudent, StudentResult
...
def student_home(request):
    ...
    course_obj = Courses.objects.get(id=student_obj.course.id)
    ...
    for subject in subject_data:
        ...
        subject_name.append(subject.subjects_name)
